...
images: ['react-nav-material-top-tabs-scrollable-thumbnail_byteck']
authors: ['heesu']
layout: PostBanner
---
...
설명의 이해를 돕기 위해, 실제 product의 핵심 일부만을 발췌해 예제로 재구성하였습니다. [해당 예제](https://snack.expo.dev/@heesuio/custom-material-scollable-top-tab)를 기준으로 설명을 진행하니 참고 바랍니다.
